...
export const metadata = { title: "Hướng Dẫn Traffic SEO — Bắt Đầu Trong 5 Phút" };
        ...
        <>
            ...
            <section className="hero" aria-label="Giới thiệu" style={{ padding: '120px 0 60px' }}>
                ...
                <div className="w" style={{ textAlign: 'center' }}>
                    ...
                    <h1 style={{ maxWidth: '800px', margin: '0 auto 1.25rem' }}>Hướng Dẫn <span className="hl-p">Traffic SEO</span><br />Chỉ <span className="hl-t">5 Phút</span> Để Bắt Đầu</h1>
            ...
            <section className="sec sec-alt">
                <div className="w">
                    ...
                    <div className="ft-grid">
                        ...
                        <div className="ft-card"><div className="ft-icon it"><i className="fas fa-arrow-down-short-wide"></i></div><h3>6. Giảm dần khi organic tăng</h3><p>Khi organic traffic tự nhiên đã tăng (kiểm tra GA), bắt đầu giảm Traffic SEO 20%/tuần. Mục tiêu cuối cùng: website đủ mạnh để tự duy trì ranking. Vẫn giữ mức duy trì 10-20 lượt/ngày.</p></div>
                    </div>
                </div>
            </section>
