...
import { RefreshCw, CheckCircle, XCircle, Search, Clock, CheckCircle2, History } from 'lucide-react';
...
export default function AdminNapTienPage() {
    ...
    const currentList = tab === 'cho_duyet' ? danhSach : lichSu;
    ...
    return (
        <div>
            ...
            <div className="card">
                {/* Tabs */}
                <div className="flex gap-6 mb-2 border-b border-border px-6 pt-4">
